...
<%
	// 로그인 중일 때
		...
		//coin = (Map<String, Object>)request.getAttribute("coin");
		...
		coin_remain = Integer.parseInt(String.valueOf(login.get("COIN_REMAIN")));
 		//coin_remain = Integer.parseInt(String.valueOf(coin.get("COIN_REMAIN")));
 		//coin_remain = Integer.parseInt((coin.get("COIN_REMAIN")).toString());
 		//coin_remain = 10000;
