...
//		return mav;
	...
	// 테스트: http://localhost:8080/member/insertMember.nds?mem_email=fan@good.com&mem_nickname=%ED%98%B8%EB%9E%91%EC%9D%B4&mem_pw=1111&mem_gender=F&mem_age=20&issocial=F&mem_phone=01056636363
...
//		return mav;
	...
	// 테스트용 url
	// 잘못된 아이디 http://localhost:8080/member/doLogin.nds?mem_email=grsdfpe@good.com&mem_pw=123&isAutoLoginChecked=true
	// [아이디 저장] http://localhost:8080/member/doLogin.nds?mem_email=grape@good.com&mem_pw=123&isSavedIdChecked=true
	// [자동 로그인] http://localhost:8080/member/doLogin.nds?mem_email=grape@good.com&mem_pw=123&isAutoLoginChecked=true
