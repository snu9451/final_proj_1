...
public class ItemController extends MultiActionController {
	...
	public void selectByCategory(HttpServletRequest req, HttpServletResponse res) {
...
//		return mav;
	...
	public void selectItemDetail(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		//상품의 댓글들을 가져온다
		List<Map<String, Object>> itemComments = itemLogic.selectItemDetailComment(pr_bm_no,"사과");
		ModelAndView mav = new ModelAndView();
		//상품의 정보를 다 담는다.
		...
		req.setAttribute("itemComments", itemComments);
		//페이지 전송
