...
//	let pw = $("#mem_pw").val();
	...
	$.ajax({
		url : "http://localhost:4444/member/updatePw.nds",
// 		url : "/ndshttp://localhost:4444/member/updatePw.nds?mem_email=banana@good.com&mem_pw="+pw+"&change_pw="+ch_pw,
		type : "post",
		data: mydata,
...
function nickSelect(){
	...
	$.ajax({
		url: "http://localhost:4444/member/selectNickName.nds",
		type : "post",
		data: mynick,
		success : function(data) {//@data-json,xml,html,text
...
function nickChange(){
	let mynick = $('#f_checknickname').serialize();
	$.ajax({
		url: "http://localhost:4444/member/updateNickName.nds",
		type : "post",
		data: mynick,
		success : function(data) {//@data-json,xml,html,text
			if(data == 1){
...
function leave(){
	...
	$.ajax({
		url : "http://localhost:4444/member/leave.nds",
		type : "post",
		data: myleave,
