...
// 		   alert("눌렀음");
		      $('.custom-control-input:checked').each(function(index){
		         ...
		         $.ajax({
		             url : "http://localhost:8080/errand/errandRecordUpdate.nds?gubun=req&errandKey="+errandKey,
		             success : function(data) {//@data-json,xml,html,text
		   ...
		   $('#errand_del_confirm1').on('click', function(){
		      $('.custom-control-input:checked').each(function(index){
		         ...
		         console.log(errandKey);
		         $.ajax({
		             url : "http://localhost:8080/errand/errandRecordUpdate.nds?gubun=nds&errandKey="+errandKey,
		             success : function(data) {//@data-json,xml,html,text
