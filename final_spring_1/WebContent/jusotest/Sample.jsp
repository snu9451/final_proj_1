...
<script language="javascript">
 ...
 function jusoCallBack(roadFullAddr,roadAddrPart1,addrDetail,roadAddrPart2,engAddr, jibunAddr, zipNo, admCd, rnMgtSn, bdMgtSn,detBdNmList,bdNm,bdKdcd,siNm,sggNm,emdNm,liNm,rn,udrtYn,buldMnnm,buldSlno,mtYn,lnbrMnnm,lnbrSlno,emdNo) {
	 document.form.roadFullAddr.value = roadFullAddr; // 도로명주소 전체(포멧)
	 document.form.roadAddrPart1.value = roadAddrPart1; // 도로명주소
 	 ...
 	 document.form.jibunAddr.value = jibunAddr; // 지번
 	 ...
 	 document.form.detBdNmList.value = detBdNmList; // 상세건물명
 /** 2017년 2월 추가제공 **/
	 document.form.bdNm.value = bdNm; // 건물명
 	 document.form.bdKdcd.value = bdKdcd; // 공동주택여부
 	 document.form.siNm.value = siNm; // 시도명
 	 document.form.sggNm.value = sggNm; // 시군구명
 	 document.form.emdNm.value = emdNm; // 읍면동명
 	 document.form.liNm.value = liNm; // 법정리명
 	 document.form.rn.value = rn; // 도로명
 	 document.form.udrtYn.value = udrtYn; // 지하여부
 	 document.form.buldMnnm.value = buldMnnm; // 건물본번
 	 document.form.buldSlno.value = buldSlno; // 건물부번
 	 document.form.mtYn.value = mtYn; // 산여부
 	 document.form.lnbrMnnm.value = lnbrMnnm; // 지번본번(번지)  
 	 document.form.lnbrSlno.value = lnbrSlno; // 지번부번(호)   
 /** 2017년 3월 추가제공 **/
 	document.form.emdNo.value = emdNo; // 읍면동일련번호
 }
</script>
 ...
 <form name="form" id="form" method="post">
  ...
  <div id="callBackDiv">
   <table>
    ...
    <tr><td>상세건물명        	</td><td><input type="text"  style="width:500px;" id="detBdNmList"  name="detBdNmList" /></td></tr>
