			...
			<div class="sidebar-scroll">
				<nav style="margin-top: 10vh;">
					<ul class="nav">
						...
						<li><a href="admin_page1.html" class=""> <span>회원관리</span></a></li>
						<li><a href="admin_page2.html" class="active"> <span>게시글관리</span></a></li>
					</ul>
				</nav>
			</div>
		</div>
									...
									<table class="table" id="products">
										...
										<tbody style="text-align: center;">
											<tr>
												...
												<td>2843</td>
												<td><a href="" onClick="window.open('admin_modal2.html', '', 'width=1350, height=690, scrollbars=no, resizable=no, toolbars=no, menubar=no')">삼성 갤럭시북2 mk15-k39393싸게 팔아요!!!</a></td>
												<td>개똥벌레</td>
												<td>2021.07.23</td>
												<td>1928</td>
												<td>3</td>
											...
											<tr>
												<td><label><input type="checkbox" ></label></td>
												<td>2843</td>
												<td><a href="javasctipt:testfn()">삼성 갤럭시북2 싸게 팔아요!!!</a></td>
												<td>개똥벌레</td>
												<td>2021.07.23</td>
												<td>1928</td>
												<td>3</td>
