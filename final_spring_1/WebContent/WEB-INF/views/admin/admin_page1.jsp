                ...
                <div class="sidebar-scroll">
                    <nav style="margin-top: 10vh;">
                        <ul class="nav">
                            ...
                            <li>
                                <a href="admin_page1.html" class="active">
                                    <span>회원관리</span></a>
                            </li>
                            <li>
                                <a href="admin_page2.html" class="">
                                    <span>게시글관리</span></a>
                            </li>
                        </ul>
                    </nav>
                            ...
                            <div class="col-lg-12">
                                        ...
                                        <table class="table" id="products">
                                            ...
                                            <tbody style="text-align: center;">
                                                <tr >
                                                    ...
                                                    <td>2021.06.25</td>
                                                    <td>
                                                        <a href="" onClick="window.open('admin_modal.html', '', 'width=1350, height=690, scrollbars=no, resizable=no, toolbars=no, menubar=no')">as97164@naver.com</a>
                                                        <!-- <a href="admin_madal.html">as97164@naver.com</a> -->
                                                    </td>
                                                    <td>호롤롤로아줌마</td>
                                                    <td>아줌마</td>
                                                    <td>60이상</td>
                                                ...
                                                <tr >
                                                    ...
                                                    <td>2021.06.25</td>
                                                    <td>
                                                        <a href="javasctipt:testfn()">as97164@naver.com</a>
                                                    </td>
                                                    <td>머리안감는오경택</td>
                                                    <td>남</td>
                                                    <td>20~30</td>
                                ...
                                <!-- <div class="paging-search" id="paging-search"> -->
                                  <div class="paging-buttons">
                                    ...
                                    <div>
                                      <button  class="my-buttons">선택회원 탈퇴</button>
