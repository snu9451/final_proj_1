...
// 		$('#in').blur(function(){
		$('#bt').on('click',function(){
			console.log('안ㄴ녕ㅇ');
			$.ajax({
// 				url: '${pageContext.request.contextPath}http://localhost:8080/member/issueTempPw.nds?mem_email=snu9451',				
// 				url: "${pageContext.request.contextPath}http://localhost:8080/member/reqLoginView.nds",				
// 				url: 'http://localhost:8080/member/ajaxHtml.nds',
				url: 'http://localhost:8080/member/leave.nds',
				type: 'get',
				dataType: "html",
...
<body style="background-color:orange;">
	...
	<form id="myform" action="http://localhost:8080/member/ajaxHtml.nds?mylist112=afafvs">
