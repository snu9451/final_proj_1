...
// 				url: "${pageContext.request.contextPath}http://localhost:4444/member/reqLoginView.nds",				
// 				url: 'http://localhost:4444/member/ajaxHtml.nds',
...
<body style="background-color:orange;">
	...
	<form id="myform" action="http://localhost:4444/member/ajaxHtml.nds?mylist112=afafvs">
