...
<script type="text/javascript">
		...
		$.ajax({
			url: 'http://192.168.0.163:9696http://192.168.0.163:9696/member/reqLoginView.nds?mem_sessionid='+mem_sessionid,
			type: 'get',
			dataType: 'json',
...
// 		alert(mem_email+', '+mem_pw+', '+isSavedIdChecked+', '+isAutoLoginChecked);
		...
		$.ajax({
			url: 'http://192.168.0.163:9696http://192.168.0.163:9696/member/doLogin.nds',
			data: dt,
			type: 'post',
			dataType: 'json',
			success: function(data){
...
// 		$('#logIn').modal('hide');
		swal("가입하신 이메일을 입력해주세요.", {
			...
			.then((value) => {
				...
				$.ajax({
					url: 'http://192.168.0.163:9696http://192.168.0.163:9696/member/issueTempPw.nds',
					data: dt,
					type: 'post',
					dataType: 'html',
					success: function(data){
