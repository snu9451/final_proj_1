...
function allItemList(pr_choice){
    ...
    $.ajax({
    	type: "GET",
    	url: "http://localhost:8080/item/selectItemList.nds",
		data: item,
...
function likeItem(itemno){	
    ...
    $.ajax({
    	type: "POST",
    	url: "http://localhost:8080/item/likeItem.nds",
		data: item,
    	success:function(data){
    		if(data==1) {
				//찜 ok
...
function deleteComment(comment){	
    ...
    $.ajax({
    	type: "POST",
    	url: "http://localhost:8080/item/deleteComment.nds",
...
// 	let msg = document.querySelector(".form-control").value; //메세지 내용
    ...
    $.ajax({
    	type: "POST",
    	url: "http://localhost:8080/item/insertComment.nds",
		data: item,
    	success:function(data){
