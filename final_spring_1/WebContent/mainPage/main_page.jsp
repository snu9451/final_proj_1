        ...
        <div class="product__title d-flex flex-column justify-content-center align-items-center mb-4">
          ...
          <div class="product__search__box d-flex flex-column align-items-center">
            ...
            <div class="product__serach__bar">
              <form id="f_autocompl"><!-- ▼ 검색창 | form 태그 시작 ▼ -->
                <div class="form-row justify-content-center align-items-center">
                  ...
                  <div id="autocomplete" style="position: absolute; z-index:10;"></div><!-- (( 검색어 자동완성이 들어갈 영역 )) -->
                  <div class="col-1">
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-md-0" data-aos="zoom-in" data-aos-delay="200">
            ...
            <div class="product__box">
              <div class="card rounded-0 mb-2">
                ...
                <!-- 좋아요버튼 -->
                <button type="button" id="likeBtn" class="btn-sm text-danger position-absolute" href=""><i class="far fa-heart"></i></button>
              </div>
