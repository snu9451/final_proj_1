    ...
    <section id="product" class="product">
      ...
      <div class="container" data-aos="fade-up">
        <div class="product__title d-flex flex-column justify-content-center align-items-center mb-4">
          <h2>지금 거래중인</h2>
          <h3 class="mb-2">우리동네 <span>중고거래상품</span></h3>
            ...
            <div class="product__serach__bar">
              <form>
                <div class="form-row justify-content-center align-items-center">
                  ...
                  <div class="col-7">
                    <input name="nds_search" type="text" class="form-control text-center" placeholder="어떤 상품들이 거래되고 있을까요? : )"
                      style="font-size: 20px;">
                  </div>
                  <div id="autocomplete" style="position: absolute; z-index:10;"></div>
                  <div class="col-1">
...
<!--                     <input name="mem_email" class="form-control mb-2 w-100" type="text" placeholder="id를 입력해주세요."> -->
<!--                     <input name="mem_pw" class="form-control mb-2 w-100" type="password" placeholder="password를 입력해주세요."> -->
<!--                   </div> -->
<!--                   <div class="col-3"> -->
<!--                     <button id="nds_login_button" class="btn btn-primary ml-1 text-center h-100 w-100" type="button">로그인</button> -->
<!--                   </div> -->
<!--               </div> -->
<!--               <div class="form-row justify-content-center col-12"> -->
<!--                 <div class="custom-control custom-checkbox col-4"> -->
<!--                   <input name="isSavedIdChecked" type="checkbox" class="custom-control-input" id="saveId"> -->
<!--                   <label class="custom-control-label" for="saveId">ID 저장</label> -->
<!--                 </div> -->
<!--                 <div class="custom-control custom-checkbox col-4"> -->
<!--                   <input name="isAutoLoginChecked" type="checkbox" class="custom-control-input" id="autoLogin"> -->
<!--                   <label class="custom-control-label" for="autoLogin">자동로그인</label> -->
<!--                 </div> -->
<!--               </div> -->
<!--               </form> -->
<!--             <a id="issueTempPw" href="#" data-toggle="modal" data-target="#tempPW" class="col-12 mb-2">비밀번호를 잊으셨나요??</a> -->
  ...
  <div class="modal modal-center fade" id="signInForm" tabindex="-1" role="dialog" aria-labelledby="signIn"
    ...
    <div class="modal-dialog modal-center" style="width: 600px;" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form class="needs-validation" id="joinForm" novalidate>
            <div class="form-group">
