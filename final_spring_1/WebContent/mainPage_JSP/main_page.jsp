...
>>>>>>> 537fca043711ac64b0153cbeb84c496c7a94ee76
	...
	<section id="Map"
		...
		<div id="map" class="col-12 col-lg-12"
...
<<<<<<< HEAD
	...
	<!-- Sign In email Modal -->
	<div class="modal modal-center fade" id="signIn" tabindex="-1"
		role="dialog" aria-labelledby="signIn" aria-hidden="true">
		<div class="modal-dialog modal-center" style="width: 400px;"
			role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h3 class="modal-title" id="exampleModalLongTitle">이메일로 회원가입
						양식을 보내드립니다.</h3>
					<button type="button" class="close" data-dismiss="modal"
						aria-label="Close">
						<span aria-hidden="true">&times;</span>
	...
	<!-- Sign In Form Modal -->
	<div class="modal modal-center fade" id="signInForm" tabindex="-1"
		role="dialog" aria-labelledby="signIn" aria-hidden="true">
		<div class="modal-dialog modal-center" style="width: 600px;"
			role="document">
			<div class="modal-content">
				<div class="modal-header">
					...
					<form class="needs-validation" novalidate>
						<div class="form-group">
							<label for="inputEmail">E-mail</label> <input type="email"
								readonly class="form-control" id="inputEmail"
								placeholder="email 자동으로 가져올예정">
						</div>
								...
								<div class="form-row align-items-center justify-content-between">
									<div class="form-group col-md-8 mb-0">
										<input type="text" class="form-control" id="inputCellPhone"
											placeholder="(-) 없이 번호를 입력해주세요." required minlength="11">
									</div>
							...
							<div class="form-group col-md-12">
								...
								<div class="form-row align-items-center justify-content-between">
									<div class="form-group col-md-9 mb-0">
										<input type="text" class="form-control" id="inputSafetyCode"
											placeholder="인증번호를 입력해주세요." required minlength="6">
									</div>
									<div class="form-group col-md-3 mb-0 text-right">
										<button type="button" class="btn btn-primary">확인</button>
									</div>
								</div>
								<small id="safetyCodeChck" class="form-text text-muted">"인증번호
									일치 여부 메세지 표시 예정"</small>
							</div>
						</div>
						<div class="form-group">
							<label for="inputPassWord">비밀번호</label> <input type="password"
								class="form-control" id="inputPassWord"
								placeholder="영문,숫자,특수문자 조합 8~20글자" required minlength="8">
							<div class="valid-feedback">Good</div>
						</div>
						<div class="form-group">
							<label for="checkPassWord">비밀번호 확인</label> <input type="password"
								class="form-control" id="checkPassWord"
								placeholder="비밀번호를 한번 더 입력해주세요." required minlength="8">
							<small id="safetyCodeChck" class="form-text text-muted">"비밀번호
								일치 여부 메세지 표시 예정"</small>
						</div>
						<div class="form-row align-items-center justify-content-between">
							<div class="form-group col-md-12">
								...
								<div class="form-row align-items-center justify-content-between">
									<div class="form-group col-md-9 mb-0">
										<input type="text" class="form-control" id="inputNickName"
											placeholder="사용하실 닉네임을 입력해주세요." required minlength="2">
									</div>
									<div class="form-group col-md-3 mb-0 text-right">
										<button type="button" class="btn btn-primary">중복확인</button>
									</div>
								</div>
								<small id="nickNameChck" class="form-text text-muted">"닉네임
									중복여부 확인 메세지 표시 예정"</small>
							</div>
						</div>
						<div class="form-group">
							<label for="inputAge">연령대</label> <select
								class="form-control custom-select" id="inputAge" required>
	...
	<!-- Coin Charge Modal -->
	<div class="modal modal-center fade" id="coinCharge" tabindex="-1"
		role="dialog" aria-labelledby="coinCharge" aria-hidden="true">
		<div class="modal-dialog modal-center" style="width: 600px;"
			role="document">
			<div class="modal-content">
				<div class="modal-header">
				...
				<div class="modal-body">
					<form id="coinCost" class="">
						<div class="form-group">
							<label for="inputCost">코인 충전</label> <input type="text"
								class="form-control" id="inputCost"
								placeholder="최소 충전 금액은 1,000원 입니다 : )">
						</div>
						<div class="modal-footer">
	...
	<!-- Errand regist Modal -->
	<div class="modal modal-center fade" id="errand_modal" tabindex="-1"
		role="dialog" aria-labelledby="errand" aria-hidden="true">
				...
				<div class="modal-body">
					<form>
						<div class="form-group">
							...
							<input type="text" class="form-control" id="errandItem"
								placeholder="어떤 심부름을 원하시나요??">
						</div>
						<div
							class="form-inline justify-content-end align-items-center mb-2">
							<h4 class="col-auto text-center mb-0" style="font-weight: bold;">금액
								제안:</h4>
							<input type="text" class="form-control col-8" id="errandItemPr"
								placeholder="예상 금액을 입력해주세요."><span class="col-auto">원</span>
						</div>
						<div
							class="form-inline justify-content-end align-items-center mb-2">
							<h4 class="col-auto text-center mb-0" style="font-weight: bold;">심부름금액:</h4>
							<input type="text" class="form-control col-8" id="errandCost"
								placeholder="심부름 금액은 최소 1,000원부터 입니다 : )"><span
								class="col-auto">원</span>
						</div>
						<hr>
						<div class="form-group">
							<label for="">심부름 상세 내용 입력</label>
							<textarea type="text" class="form-control" id="errandDetail"
								placeholder="상세 내용을 입력해주세요."></textarea>
						</div>
						<div
							class="form-inline justify-content-between align-items-center mb-2">
							<label class="col-auto text-center"> <i
								class="fas fa-map-marker-alt mr-1"
								style="color: rgb(0, 89, 255); font-size: 20px;"></i> 현재 나의 위치:
							</label> <input type="text" class="col-6 form-control" id="errandAddr"
								placeholder="주소를 입력해주세요.">
							<button type="button" id="searchAddr"
								class="col-3 btn btn-primary">주소검색</button>
						</div>
						<div class="form-row justify-content-center mb-1">
							<span class="mr-1"><i class="fas fa-exclamation warn"
								style="color: red; font-size: 20px; font-weight: bold;"></i></span> <small
								class="text-center"> <span>심부름 요청은 등록 후 <span
									class="warn" style="color: red; font-weight: bold;">30분간
										유지되며</span> 30분동안 심부름이 매칭되지 않았을 때,<br> <span class="warn"
									style="color: red; font-weight: bold;">자동으로 등록이 취소됩니다.</span>
							</span>
							</small>
						</div>
						<div
							...
							<div
								class="col-9 d-flex justify-content-end align-items-baseline">
								<h3 id="totalCost" class="col-auto">"총금액 위치예정"(6,500)</h3>
								<span class="col-auto">원</span>
							</div>
						</div>
						<div class="modal-footer">
							<button type="submit" id="errandBtn" class="btn btn-primary">심부름
								등록하기</button>
	...
	<!-- report_board Modal -->
	<div class="modal modal-center fade" id="report_board" tabindex="-1"
		role="dialog" aria-labelledby="report_board" aria-hidden="true">
		<div class="modal-dialog modal-center" role="document">
			<div class="modal-content" style="width: 650px;">
				<div class="modal-header">
					<div class="d-flex justify-content-center align-items-center">
						<i class="fas fa-exclamation-circle"
							style="font-size: 2rem; color: rgb(255, 39, 39);"></i>
				...
				<div class="modal-body">
					<form id="report_content_board" class="">
						...
						<div class="form-group">
							...
							<div class="form-row">
								<div class="col-7">
									<label class="mr-2">신고대상 게시글 번호:</label> <span class="mr-2">No.</span><span
										id="report_num_board">100000</span>
								</div>
								<div class="col-5">
							...
							<textarea type="text" class="form-control"
								id="report_detail_board" placeholder="상세 내용을 입력해주세요." rows="5"></textarea>
						</div>
						<div class="input-group">
							...
							<div class="custom-file">
								<input type="file" class="report_file" id="report_file_board"
									aria-describedby="inputGroupFileAddon01"> <label
									class="custom-file-label" id="report_file_name_board"
									for="report_file_board"> 파일은 최대 10MB까지 가능합니다. </label>
							</div>
						</div>
					</form>
					<div class="modal-footer">
	...
	<!-- report_user Modal -->
	<div class="modal modal-center fade" id="report_user" tabindex="-1"
		role="dialog" aria-labelledby="report_user" aria-hidden="true">
		<div class="modal-dialog modal-center" role="document">
			<div class="modal-content" style="width: 650px;">
				<div class="modal-header">
					<div class="d-flex justify-content-center align-items-center">
					...
					<form id="report_content_user" class="">
						<div class="form-group">
							...
							<div class="form-group">
								...
								<textarea type="text" class="form-control"
									id="report_detail_user" placeholder="상세 내용을 입력해주세요." rows="5"></textarea>
							</div>
							<div class="input-group">
								<div class="input-group-prepend">
								...
								<div class="custom-file">
									<input type="file" class="report_file_user"
										id="report_file_user" aria-describedby="inputGroupFileAddon01">
									<label class="custom-file-label" id="report_file_name_user"
										for="report_file_user"> 파일은 최대 10MB까지 가능합니다. </label>
								</div>
							</div>
					</form>
					<div class="modal-footer">
						<button type="button" id="report_btn_user"
							class="btn btn-primary sweet">신고하기</button>
						<button type="button" class="btn btn-danger" data-dismiss="modal">닫기</button>
					</div>
				</div>
			</div>
...
=======
  ...
  <!-- Sign In Form Modal -->
  <div class="modal modal-center fade" id="signInForm" tabindex="-1" role="dialog" aria-labelledby="signIn"
    aria-hidden="true">
          ...
          <form class="needs-validation" novalidate>
            ...
            <div class="form-row align-items-center">
              <div class="form-group col-md-12">
                ...
                <div class="form-row align-items-center justify-content-between">
                  <div class="form-group col-md-8 mb-0">
                    <input type="text" class="form-control" id="inputCellPhone" placeholder="(-) 없이 번호를 입력해주세요." required
                    minlength="11">
                  </div>
                  <div class="form-group col-md-4 mb-0 text-right">
                    <button type="button" class="btn btn-primary">인증번호 받기</button>
            ...
            <div class="form-row align-items-center justify-content-between">
              <div class="form-group col-md-12">
                ...
                <small id="safetyCodeChck" class="form-text text-muted">"인증번호 일치 여부 메세지 표시 예정"</small>
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input type="password" class="form-control" id="checkPassWord" placeholder="비밀번호를 한번 더 입력해주세요." required
                minlength="8">
              <small id="safetyCodeChck" class="form-text text-muted">"비밀번호 일치 여부 메세지 표시 예정"</small>
            </div>
            <div class="form-row align-items-center justify-content-between">
              <div class="form-group col-md-12">
                <label for="inputNickName">닉네임</label>
                <div class="form-row align-items-center justify-content-between">
                  <div class="form-group col-md-9 mb-0">
                    <input type="text" class="form-control" id="inputNickName" placeholder="사용하실 닉네임을 입력해주세요." required
                    minlength="2">
                  </div>
                  <div class="form-group col-md-3 mb-0 text-right">
                    <button type="button" class="btn btn-primary">중복확인</button>
                ...
                <small id="nickNameChck" class="form-text text-muted">"닉네임 중복여부 확인 메세지 표시 예정"</small>
              </div>
            </div>
            <div class="form-group">
              <label for="inputAge">연령대</label>
              <select class="form-control custom-select" id="inputAge" required>
                <option selected>고객님의 연령대를 선택해주세요.</option>
                <option value="1">10대</option>
                <option value="2">20대</option>
                <option value="3">30대</option>
            ...
            <div class="custom-control custom-radio custom-control-inline">
              <input type="radio" id="female" name="radioBtn" class="custom-control-input" required>
              <label class="custom-control-label" for="female">여성</label>
            </div>
            <div class="custom-control custom-radio custom-control-inline">
              <input type="radio" id="male" name="radioBtn" class="custom-control-input" required>
  ...
  <!-- Errand regist Modal -->
  <div class="modal modal-center fade" id="errand_modal" tabindex="-1" role="dialog" aria-labelledby="errand"
    aria-hidden="true">
    <div class="modal-dialog modal-center" role="document">
      <div class="modal-content" style="width: 700px;">
        <div class="modal-header">
  ...
  <!-- report_user Modal -->
  <div class="modal modal-center fade" id="report_user" tabindex="-1" role="dialog" aria-labelledby="report_user"
    aria-hidden="true">
    <div class="modal-dialog modal-center" role="document">
      <div class="modal-content" style="width: 650px;">
        <div class="modal-header">
