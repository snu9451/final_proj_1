  ...
  <body>
    ...
    <header id="header" class="fixed-top">
      <div class="container d-flex align-items-center">
        <img
          class="myBro__logo mr-2"
          src="assets/img/mybro_favicon1.png"
          alt="mybro_favicon"
        />
        ...
        <nav class="nav-menu d-none d-lg-block">
          <ul>
            ...
            <div>
              <li>
                <a href="#" data-toggle="modal" data-target="#logIn">로그인</a>
              </li>
              <li>
                <a href="#" data-toggle="modal" data-target="#signInForm"
                  >회원가입</a
                >
              </li>
              <li>
                <a href="#" data-toggle="modal" data-target="#report_user"
                  >모달test</a
                >
              </li>
      ...
      <section id="product" class="product__description col-12 col-lg-12">
        <div class="container mt-3" id="pd__top" data-aos="fade-up">
          <div class="row h-100 justify-content-around p-2" id="pd__box">
            ...
            >
              <div
                class="owl-carousel owl-theme owl-slider text-center"
            ...
            >
              ...
              <div class="mt-3" id="pd__middle">
                <p>
                  나이키 데이브레이크 5번밖에 안신었어요 더 예쁜거 사게되서
                  팝니당 사이즈 260
                </p>
              </div>
              <div class="position-relative">
                ...
                >
                  ...
                  >
                    ...
                    <div class="ml-3">
                      <a id="pd__seller__chat">
                        대화하기 <i class="far fa-comments"></i>
                      </a>
                    </div>
                  </div>
                  <div class="d-flex align-items-baseline">
