...
<link href="assets/css/main_page.css?v=<%=System.currentTimeMillis()%>" rel="stylesheet">
				...
				<div
					...
					<div
						...
						<div
							...
							<a id="like_rank"  href="javascript:void(0);" onclick="allItemList(this)">인기상품순</a>
							<div class="divider"></div>
							<a id="new_rank"  href="javascript:void(0);" onclick="allItemList(this)" >최근상품순</a>
							<div class="divider"></div>
							<a href="#">연령별</a>
						</div>
						<div class="product__serach__bar">
							<form>
								<div class="form-row justify-content-center align-items-center">
									...
									<div class="col-1">
										<button type="button" class="btn btn-outline-light btn-lg" onclick="itemSearch()">Search</button>
									</div>
								</div>
							</form>
						</div>
...
<!-- ============================= End Used goods ========================= -->
		<%@ include file="main_page_item.jsp" %>
	...
	<script defer src="assets/js/main_page2.js"></script>
