...
import com.example.android_nds.adapter.TradeBuyAdapter
import com.example.android_nds.databinding.FragmentMyTradeBuyBinding
import com.example.android_nds.interceptor.LoginHandleInterceptor
import com.example.android_nds.model.TradeBuy
import com.example.android_nds.api.TradeBuyService
...
class MyTradeBuyFragment : Fragment(R.layout.fragment_my_trade_buy) {
    ...
    override fun onCreateView(
        ...
        // 구매내역 불러오기
        tradeBuyService.getTradeBuy("buy")
