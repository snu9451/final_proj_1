...
import com.example.android_nds.databinding.CoinBinding
import com.example.android_nds.databinding.TradeBuyBinding
    ...
    inner class TradeBuyViewHolder(private val binding: TradeBuyBinding): RecyclerView.ViewHolder(binding.root) {
        fun bind(tradeBuyModel: TradeBuy) {
            ...
            Glide
                ...
                .load("http://115.91.81.108:9696/itemPage/assets/img/board_Img/" + tradeBuyModel.biFile)
