...
class MainActivity : AppCompatActivity(), OnMapReadyCallback, GoogleMap.OnMarkerClickListener {
    ...
    private lateinit var allListItemFragment: AllListItemFragment
...
//        val ndsMapFragment = NDSMapFragment()
        allListItemFragment = AllListItemFragment()
        // 지도 설정
...
//                    startActivity(intent)
                ...
                R.id.nav_myErrand -> {
                    Log.i(TAG,"심부름 내역 클릭")
                    val intent = Intent(this, MyErrandActivity::class.java)
                    startActivity(intent)
                }

                // 중고거래 내역 클릭시
                R.id.nav_myTrade -> {
                    Log.i(TAG,"중고거래 내역 클릭")
...
//            ).show()
            Log.i(TAG, currentLocation.latitude.toString() + "," +
...
//                replace(R.id.willbereplaced, fragment)
    ...
    override fun onBackPressed() {
        ...
        // AllListItemFragment에서 History View가 열려있다면 닫기
        else if (currentFragment == allListItemFragment && allListItemFragment.binding.historyRecyclerView.isVisible ){
            allListItemFragment.binding.historyRecyclerView.isVisible = false
        }
